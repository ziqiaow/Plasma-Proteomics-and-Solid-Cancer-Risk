...
if(cancer =="prostate"){
  ...
  save(cox.res,zp, file = paste0(in.dir,"cox_fit_minimal_",cancer,"_smk.RData"))
  ...
  names(cox.res) = names(zp) = colnames(prot_norm)
  save(cox.res,zp, file = paste0(in.dir,"cox_fit_minimal_colorectal_smk.RData"))
  ...
  names(cox.res) = names(zp) = colnames(prot_norm)
  save(cox.res,zp, file = paste0(in.dir,"cox_fit_minimal_rectal_smk.RData"))
  ...
  names(cox.res) = names(zp) = colnames(prot_norm)
  save(cox.res,zp, file = paste0(in.dir,"cox_fit_minimal_colon_smk.RData"))
