...
gwas_clean = load_gwas_tsv(gwas_file = "/dcs04/nilanjan/data/zwang/collaboration/ARIC_Cancer/coloc/data/GCST90320057.h.tsv.gz")
...
results <- run_coloc_for_proteins(
  ...
  output_dir = "/dcs04/nilanjan/data/zwang/collaboration/ARIC_Cancer/coloc/coloc_results/EA/kidney2",
